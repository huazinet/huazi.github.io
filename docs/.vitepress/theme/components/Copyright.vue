            ...
            <div class="msgcard">
                ...
                <div class="copyright" v-if="website?.showFooter">
                    ...
                    <a class="beian strong" target="_blank" v-if="website?.icpRecordCode"
                        href="https://sharehub.club/posts/2024/04/bilibili_automation.html">B站截流</a> | <a class="beian strong"
                        target="_blank"
                        href="https://sharehub.club/posts/2024/03/Bot_detial.html">短剧Bot</a>
                </div>
            </div>
